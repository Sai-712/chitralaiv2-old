          ...
          {faqs.map((faq, index) => (
            <div key={index} className="py-2 sm:py-3">
              <button
                ...
                className="flex w-full items-start justify-between text-left py-1 sm:py-2 focus:outline-none"
              >
              ...
              <div className={`mt-1 pr-6 sm:pr-12 ${openIndex === index ? 'block' : 'hidden'}`}>
