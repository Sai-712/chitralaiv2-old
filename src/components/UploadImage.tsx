  ...
  return (
    <div className="relative min-h-screen bg-grey-100">
      <div className="container mx-auto px-4 py-2 relative z-10">
        <div className="mb-4 flex flex-col sm:flex-row justify-center items-start sm:items-center gap-4">
        ...
        <div className="relative z-10 container mx-auto px-4 py-4">
          <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md border-4 border-blue-900">
            <div className="flex flex-col items-center justify-center mb-6 space-y-4">
              ...
              <h2 className="text-2xl font-bold text-black text-center">Upload Images</h2>
            </div>
